...
var renameKeys = [][]string{
	...
	[]string{"Medical-DrH", "valley", "orthopaedic"},
	...
	[]string{"Rindge-HVAC", "ER", "Heating"},
	[]string{"Marriott-Santa-Fe"},
	[]string{"CLAPA-Board"},
	[]string{"Citi-AAdvantage"},
	[]string{"Sedona-Home-Depot", "1030", "STATE", "ROUTE", "260", "COTTONWOOD"},
	[]string{"Eastern-Propane-Oil-Delivery", "danvers", "322-6628"},
	[]string{"In-Memory-David-Larrabee", "larrabee"},
	[]string{"Rindge-Septic", "wind", "river"},
	[]string{"CLAPA-VLAP", "hampshire", "chlorophyll-a"},
	[]string{"CLAPA-VLAP", "Volunteer", "Lake"},
	[]string{"Yellowstone-Association"},
	[]string{"Craig-Gustafson"},
	[]string{"Tallman-Eye"},
	[]string{"Citibank"},
	[]string{"Springdell-Farm"},
	[]string{"Sedona-Heritage"},
	[]string{"Refill-RX"},
	[]string{"Dream-Home-Source"},
	[]string{"Siognature-Door", "octagon", "vinyl", "windows"},
	[]string{"Ameritrade"},
	[]string{"Caribbean-Cruise", "passport", "sailing"},
	[]string{"Brotherhood-Calendar"},
	[]string{"Pioneer-Title"},
	[]string{"Sedona-Buckboard-Sale", "buckboard", "sale"},
	[]string{"Groton-CVS", "groton", "pharmacy"},
	[]string{"Sustainable-Forestry"},
	[]string{"Chase-Bank-Card"},
	[]string{"Eric-Check", "somerset", "hills", "bank"},
	[]string{"Payflex"},
	[]string{"Sedona-City-Council"},
	[]string{"Rental-Vehicle"},
	[]string{"Walgreens-Littleton"},
	[]string{"Chelmsford-Dermatology"},
	[]string{"Groton-Zoning-Board"},
	[]string{"Body-Fat-Tracking"},
	[]string{"Watts-Regulator", "south", "haney", "easton"},
	[]string{"TrueBlue"},
	[]string{"Georgeson-Securities"},
	[]string{"Lazard"},
	[]string{"Groton-James-Brook-Survey"},
	[]string{"Computer-Society-Digital"},
	[]string{"Keene-Bed-Bath-Beyond"},
	[]string{"Groton-Moison-Ace"},
	[]string{"Flex-Plan"},
	[]string{"Flic-Scanner"},
	[]string{"Dale-Glow", "glow", "pc"},
	[]string{"Citi-Alternative-Investments"},
	[]string{"Prestige-Electrolysis"},
	[]string{"Manchester-Airport-Parking"},
	[]string{"Goodales-Bike"},
	[]string{"Matson-Attorney"},
	[]string{"Merrimack-Urology", "merrimackurology"},
	//
